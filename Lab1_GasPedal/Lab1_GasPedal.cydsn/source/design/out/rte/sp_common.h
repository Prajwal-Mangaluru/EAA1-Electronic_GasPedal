...
/*
 * description: A Signal that reads joystick value
 * indriver: default
 * name: so_joystick
 * onDataError: 0
...
/*
 * description: A Signal to represent the speed value
 * indriver: 0
 * name: so_speed
 * onDataError: 0
...
/*
 * description: A Signal to represent the engine value
 * indriver: 0
 * name: so_engine
 * onDataError: 0
 * onDataUpdate: 0
...
/*
 * description: A Signal to represent the brakelight value
 * indriver: 0
 * name: so_brakelight
 * onDataError: 0
 * onDataUpdate: 0
