 ...
 *
 * description: This task will calculate value of joystick signal 
...
const RTE_eventTable_t RTE_eventActivationTable_tsk_control[] = {
    { CONTROL_calcControl_run, ev_joystick_onData },  //Runnable that checks the joystick signal and depending upon that value speed signal is updated
}; 
