// ======================================================================
// Lab1_GasPedal.v generated from TopDesign.cysch
// 05/21/2025 at 19:10
...
module ADC_SAR_SEQ_v2_10_1 (
	...
	cy_clock_v1_0
		#(.id("6ed18786-5339-49e2-9c68-635a5f299892/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("6ed18786-5339-49e2-9c68-635a5f299892/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("4854dba8-0874-4e75-a080-ee6c2c019693"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_2 Engine_PWM (
        ...
        .tc(Net_985),
        .trigger(1'b0));
    defparam Engine_PWM.Resolution = 8;

	wire [0:0] tmpOE__Engine_LED_net;
	wire [0:0] tmpFB_0__Engine_LED_net;
	wire [0:0] tmpIO_0__Engine_LED_net;
	wire [0:0] tmpINTERRUPT_0__Engine_LED_net;
	electrical [0:0] tmpSIOVREF__Engine_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Engine_LED
		 (.oe(tmpOE__Engine_LED_net),
		  .y({Net_271}),
		  .fb({tmpFB_0__Engine_LED_net[0:0]}),
		  .io({tmpIO_0__Engine_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Engine_LED_net),
		  .interrupt({tmpINTERRUPT_0__Engine_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Engine_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Brake_LED_net;
	wire [0:0] tmpFB_0__Brake_LED_net;
	wire [0:0] tmpIO_0__Brake_LED_net;
	wire [0:0] tmpINTERRUPT_0__Brake_LED_net;
	electrical [0:0] tmpSIOVREF__Brake_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("eebc6ef4-a5f1-42be-b9ae-44e01b5742c7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Brake_LED
		 (.oe(tmpOE__Brake_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Brake_LED_net[0:0]}),
		  .io({tmpIO_0__Brake_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Brake_LED_net),
		  .interrupt({tmpINTERRUPT_0__Brake_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Brake_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__UART_Rx_LOG_net;
	wire [0:0] tmpIO_0__UART_Rx_LOG_net;
	wire [0:0] tmpINTERRUPT_0__UART_Rx_LOG_net;
	electrical [0:0] tmpSIOVREF__UART_Rx_LOG_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		UART_Rx_LOG
		 (.oe(tmpOE__UART_Rx_LOG_net),
		  .y({1'b0}),
		  .fb({Net_119}),
		  .io({tmpIO_0__UART_Rx_LOG_net[0:0]}),
		  .siovref(tmpSIOVREF__UART_Rx_LOG_net),
		  .interrupt({tmpINTERRUPT_0__UART_Rx_LOG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UART_Rx_LOG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__UART_Tx_LOG_net;
	wire [0:0] tmpFB_0__UART_Tx_LOG_net;
	wire [0:0] tmpIO_0__UART_Tx_LOG_net;
	wire [0:0] tmpINTERRUPT_0__UART_Tx_LOG_net;
	electrical [0:0] tmpSIOVREF__UART_Tx_LOG_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		UART_Tx_LOG
		 (.oe(tmpOE__UART_Tx_LOG_net),
		  .y({Net_123}),
		  .fb({tmpFB_0__UART_Tx_LOG_net[0:0]}),
		  .io({tmpIO_0__UART_Tx_LOG_net[0:0]}),
		  .siovref(tmpSIOVREF__UART_Tx_LOG_net),
		  .interrupt({tmpINTERRUPT_0__UART_Tx_LOG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UART_Tx_LOG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("5250516e-5f05-404e-ac1e-0d608ce9c7fe"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
