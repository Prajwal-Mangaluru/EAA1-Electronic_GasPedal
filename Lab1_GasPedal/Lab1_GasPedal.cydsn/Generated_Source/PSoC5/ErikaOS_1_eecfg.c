 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_1[TASK_1_STACK_SIZE];	/* Task 1 (tsk_io) */
    #endif
    #if ((2 == 2) && (EE_MAX_TASK > 1))
    #define TASK_2_STACK_SIZE 8192/4 // size = 8192 bytes
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        {0}
        #ifdef TASK_1_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_1[(TASK_1_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}	/* tsk_io*/
        #endif
        #ifdef TASK_2_STACK_SIZE
